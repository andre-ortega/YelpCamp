...
The demo is available on one of my Heroku distros, [here](https://nameless-scrubland-88013.herokuapp.com/). It will take a few moments to load due to it being hosted in a free dyno, and therefore does not have permanently allocated server resources, but dynamically allocated resources by request. You can operate the site just like you would to test the operations of a basic Yelp clone used specifically for campsites. You may create an account, a campsite, edit/delete your campgrounds, and leave reviews on other sites.
